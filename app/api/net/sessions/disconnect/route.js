...
export async function POST(request) {
  ...
  try {
    ...
    return NextResponse.json({ ok: true, command: "DISCONNECT_USER", target: parsed.data.id, reason: parsed.data.reason ?? "operator_request", provider: "mikrotik-rest", result, verified: false, verificationRequired: true });
  } catch (error) {
