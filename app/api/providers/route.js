...
export async function GET() {
  ...
  } catch (error) { return NextResponse.json({ ok: false, providers: [], error: error instanceof Error ? error.message : "Unable to inspect Jaslyn providers." }, { status: 500, headers: { "cache-control": "no-store" } }); }
}
